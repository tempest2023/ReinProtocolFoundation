...
AI Agents 正逐步具备研究、协调、创造和代表个人或组织行动的能力。这些能力可以扩大知识的可及性，帮助回应公共需求，也可能导致权力集中或削弱人类的有效控制。Rein 希望引导这种新兴能力服务公共利益，同时让其使用过程可检查、可追责。

我们认为，这既是技术问题，也是制度问题。开放教育和公共讨论使更多人能够参与 AI 决策；研究、治理机制和明确的 Agent 权限边界，则有助于确保有用的系统始终对其影响的社群负责。

## 初始项目

创始蓝图确认了四个初始公益项目方向。以下描述的是组织计划开展的工作，并不表示每项活动都已上线。

1. **公共传播与 AI 社区教育。** 通过通俗文章、研究摘要、对话和多语言公共材料，解释有益且安全的 AI Agents，推动 AI 社区中的知情参与。
2. **AI Agent 研究与交流活动。** 关注并参与伦理、安全、治理和基础设施研究；在研究者聚集的场合举办独立工作坊、圆桌和讨论，并准确说明与任何学术会议的关系。
...
社区以开放为默认原则。无需注册，也可以访问公开学习资源和活动；自愿登记可以收到与兴趣和地区相关的动态。承担持续工作的 Contributor 则有独立的参与路径。

| 角色 | 参与方式 |
| --- | --- |
| **Public Participant（公开参与者）** | 无需注册即可阅读资源、参加开放活动。 |
| **Community Participant（社区参与者）** | 登记以接收社区动态并保持联系。 |
...
[创始章程与运营蓝图](./PROJECT.md)仍是草案。法律设立、税务地位、募款安排和部分治理机制仍待审核或采纳。网站与本仓库说明拟建设的机构，并提供公开社区入口；不能据此认定计划中的课程、活动、资助或自动化社区运营已经启动。

[Agent 社区运营产品需求](./docs/PRD-agent-community-operations-zh.md)（[English](./docs/PRD-agent-community-operations.md)）描述未来拟议的工作流程，而非现有功能。参与网站和应用开发请参阅[开发指南](./DEVELOPMENT-zh.md)；品牌素材及使用说明位于 [public/brand](./public/brand/README.md)。
