  ...
  return (
    <main id="main-content">
      ...
      <section className="giving-section" id="giving" aria-labelledby="giving-title">
        ...
        <div className="giving-content" data-reveal><p className="section-index">05 / Giving</p><h2 id="giving-title">Giving is built on operational trust.</h2><p className="giving-lead">Our giving rails serve both people and Agents: crypto, stablecoins and conventional payments governed by legal, custody, screening and accounting controls.</p><div className="giving-standard"><span>Foundation status</span><strong>Registered. Operational. Accountable.</strong></div><p className="asset-summary">BTC · ETH · BNB · approved stablecoins · reviewed assets · fiat rails</p><TextLink href="/giving">Review our giving standards</TextLink></div>
      </section>
...
export function GivingPage() {
  return <main id="main-content"><ArticleHero eyebrow="Giving architecture" title="Native to the Agent economy. Bound to charitable law." lead="Rein supports conventional and digital-asset gifts through verified channels. Every accepted asset is screened, recorded and governed as charitable property." image={losAngeles} imagePosition="50% 100%" caption="Looking beyond / Los Angeles" />
    <ArticleLayout summaryLabel="Official-channel policy" summary="Rein Protocol Foundation is a registered nonprofit organization. Give only through verified Foundation channels, each published with its network, asset, custody and receipt information.">
      ...
      <aside className="article-inset" data-reveal><p className="article-kicker">Official channels</p><h2>Giving operates through verified Foundation channels.</h2><p>Use only wallet addresses and payment links published on this canonical site. Every official channel is governed by the Foundation’s gift-acceptance, custody, screening, accounting and receipt controls.</p></aside>
